...
using System.IO;
using Simples.SampleBased.ObstacleSpace;
using Simples.SampleBased.ConfigurationSpace;
using Simples.SampleBased.Util;
...
namespace PathFinder
{
    ...
    public partial class Form1 : Form
    {
        ...
        {
            // Lê espaço de configurações da figura e organiza em uma matriz
            ...
            CSpacePRM tst = new CSpacePRM(2, new int[] { 800, 600 }, cObsSpace, N, k, PRMSampleMethod.Random);
