...
namespace WindowsFormsApplication1
{
    ...
    public class CSpacePRM : CSpace
    {
        ...
        public void generatePath(int[] origin, int[] dest, int k, out Node originNode, out Node destNode)
        {
            if (sampleList == null)
            {
                switch (sampleMethod)
    ...
    public class CSpaceRRT : CSpace
    {
        ...
        public void generatePath(int[] origin, int[] dest, out Node originNode, out Node destNode)
        {
            originNode = new Node(origin);
